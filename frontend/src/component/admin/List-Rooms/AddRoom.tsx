  ...
  <div className="page-header">
    <div className="header-wrapper row m-0">
      <div className="header-logo-wrapper col-auto p-0">
        <div className="logo-wrapper"><a href="index.html"> <img className="img-fluid for-light" src="../assets/images/logo/logo.png" alt /><img className="img-fluid for-dark" src="../assets/images/logo/logo_dark.png" alt /></a></div>
        ...
        <ul className="nav-menus">
          ...
          <li className="cart-nav onhover-dropdown">
            ...
            <div className="cart-dropdown onhover-show-div">
              ...
              <ul>
                <li>
                  <div className="d-flex"><img className="img-fluid b-r-5 img-50" src="../assets/images/ecommerce/05.jpg" alt />
                ...
                <li>
                  <div className="d-flex"><img className="img-fluid b-r-5 img-50" src="../assets/images/ecommerce/02.jpg" alt />
