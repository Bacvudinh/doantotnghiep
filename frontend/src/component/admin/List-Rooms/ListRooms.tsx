                  ...
                  <table className="table" id="project-status">
                    <thead> 
                      <tr> 
                        ...
                        <th> <span className="f-light f-w-600">Ảnh</span></th>
                        <th> <span className="f-light f-w-600">Tên phòng</span></th>
                        <th> <span className="f-light f-w-600">Mã tòa</span></th>
                        <th> <span className="f-light f-w-600">Diện tích</span></th>
                        <th> <span className="f-light f-w-600">Giá thuê</span></th>
                        <th> <span className="f-light f-w-600">Số người tối đa</span></th>
                        <th> <span className="f-light f-w-600">Tiện nghi</span></th>
                        <th> <span className="f-light f-w-600">Mã tầng</span></th>
                        <th> <span className="f-light f-w-600">Trạng thái</span></th>
                    ...
                    <tbody> 
                      <tr className="product-removes">
                       ...
                       <td> 
                        ...
                        <td> 
                          <p className="f-light">10m</p>
                        </td>
                        <td> 
                          <p className="f-light">4.000.000</p>
                        </td>
                         <td> 
                          <p className="f-light">4</p>
                        </td>
                       <td> 
                          <p className="f-light">Tủ,Giường</p>
                        </td>
                          <td> 
                          <p className="f-light">A2</p>
                        </td>
                        <td> 
                          <p className="f-light">Đã cho thuê</p>
                        </td>
                      </tr>
