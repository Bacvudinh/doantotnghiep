            ...
            <div className="container-fluid default-dashboard">
              <div className="row">
                ...
                <div className="d-flex align-items-center justify-content-center latest-sales-btn">
                  <button className="btn btn-square btn-outline-primary btn-sm" type="button" title="btn btn-square btn-outline-primary btn-sm">Yearly</button>
                  <button className="btn btn-square btn-outline-primary btn-sm" type="button" title="btn btn-square btn-outline-primary btn-sm">Monthly</button>
                  <button className="btn btn-square btn-outline-primary btn-sm active" type="button" title="btn btn-square btn-outline-primary btn-sm">Weekly</button>
                </div>
              </div> */}
